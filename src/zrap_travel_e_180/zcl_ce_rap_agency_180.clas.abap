CLASS zcl_ce_rap_agency_180 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES t_agency_range TYPE RANGE OF z_travel_agency_es5-Agency_Id.
...
CLASS zcl_ce_rap_agency_180 IMPLEMENTATION.
  ...
  METHOD get_agencies.
    ...
    service_consumption_name = to_upper( 'ZSC_RAP_AGENCY_180' ).
